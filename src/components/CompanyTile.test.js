...
test('CompanyTile component: Creation', () => {
    ...
    // Tile Name
    expect(getByText('Riot Games')).toBeTruthy();
    
    // Tile Viewers
    expect(getByText('7,654,321 viewers')).toBeTruthy();
    
    // Tile Image
    let icon = getByRole('img');
    expect(icon.src).toEqual('https://images.igdb.com/igdb/image/upload/t_logo_med/cl2fe.png');
});
